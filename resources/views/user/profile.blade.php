...
@section('content')
    ...
    @if(auth()->check() && auth()->user()->id === $user->id)
        <a href="/export-pdf" class="m-2" style="text-decoration: none; margin-right: 40px; cursor: pointer; position: absolute; right: 50px;top: 95px">
            <div class="d-flex align-items-center" style="padding: 10px 15px; height: 50px; width: fit-content; background-color: white; box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px; border-radius: 25px;">
                <i class="bi bi-file-earmark-spreadsheet text-dark" style="font-size: 20px"></i>
