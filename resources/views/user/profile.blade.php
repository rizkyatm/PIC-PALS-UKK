<!DOCTYPE html><html lang="en"><head>
    ...
    <main role="main">
        <div class="container mb-4 d-flex flex-column justify-content-center align-items-center mt-4">
            ...
            <p class="mb-0">
                ini akun saya cuman bakal test doang kokkkkk
            </p>
                            ...
                            <div class="card-body rounded-0 text-left p-3">
                                ...
                                <form id="updateProfileForm" enctype="multipart/form-data" method="POST">
                                    ...
                                    <div class="form-group icon-input mb-3">
                                        ...
                                        <input type="text" name="email" id="email" class="style2-input ps-5 form-control text-grey-900 font-xsss fw-600" placeholder="Email" value="{{$user->email}}">
                                    </div>
                                    <div class="form-group icon-input mb-3">
                                        <label for="username" class="text-dark" style="font-weight: bold">Username</label>
                                        <input type="text" name="username" id="username" class="style2-input ps-5 form-control text-grey-900 font-xsss fw-600" placeholder="Username" value="{{$user->username}}">
                                    </div>
                                    <div class="form-group icon-input mb-3">
                                        <label for="nama_lengkap" class="text-dark" style="font-weight: bold">Nama Lengkap</label>
                                        <input type="text" name="nama_lengkap" id="nama_lengkap" class="style2-input ps-5 form-control text-grey-900 font-xsss fw-600" placeholder="Nama Lengkap" value="{{$user->nama_lengkap}}">
                                    </div>
                                    <div class="form-group icon-input mb-3">
                                        <label for="alamat" class="text-dark" style="font-weight: bold">Alamat</label>
                                        <input type="text" name="alamat" id="alamat" class="style2-input ps-5 form-control text-grey-900 font-xsss fw-600" placeholder="Alamat" value="{{$user->alamat}}">
                                    </div>
                                    <div class="form-group icon-input mb-3">
                                        <label for="password_old" class="text-dark" style="font-weight: bold">Confirm Password</label>
                                        <input type="password" name="password_old" id="password" class="style2-input ps-5 form-control text-grey-900 font-xss ls-3" placeholder="Password">
                                    </div>
                                    <div class="form-group icon-input mb-3">
                                        <label for="password_new" class="text-dark" style="font-weight: bold">New Password</label>
                                        <input type="password" name="password_new" id="password" class="style2-input ps-5 form-control text-grey-900 font-xss ls-3" placeholder="Password">
                                    </div>
                                    <div class="card">     
                                    ...
                                    <div class="col-sm-12 p-0 text-left">
                                        <div class="form-group mb-3">
                                            <button type="submit" class="form-control text-center style2-input text-white fw-600 bg-dark border-0 py-2">Update Profile</button>
                                        </div>
                                    </div>
                                </form>
