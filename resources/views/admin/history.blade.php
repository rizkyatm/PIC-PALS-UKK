                        ...
                        <tbody>
                            @foreach ($reports as $report)
                                <tr>
                                    ...
                                    <td> 
                                        @if($report->status === 'Laporan valid')
                                            <a href=""><span class="badge bg-success">{{ $report->status }}</span></a>
                                        @elseif($report->status === 'Laporan Tidak valid')
                                            <a href=""><span class="badge bg-danger">{{ $report->status }}</span></a>
                                        @else
                                            <a href=""><span class="badge bg-warning">{{ $report->status }}</span></a>
                                        @endif
                                    </td>
